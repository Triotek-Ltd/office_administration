"""Relation service seed for access_grant."""
...
DOC_ID = "access_grant"
RELATED_DOCS = [{'doc_id': 'office_file_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'user_account', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'file context from office_file_record'}]

...
DOC_ID = "access_grant"
RELATED_DOCS = [{'doc_id': 'office_file_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'access class'}, {'description': 'owner from office_file_record'}]

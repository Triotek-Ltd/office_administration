"""Relation service seed for office_file_record."""
...
RELATED_DOCS = [{'doc_id': 'version_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'access_grant', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

"""Relation service seed for meeting_record."""
...
RELATED_DOCS = [{'doc_id': 'meeting_action_item', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'attendee names from linked participant records where present'}]

"""Business-domain service seed for Document Access Request."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['open', 'in_review', 'resolved', 'closed'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'requester': 'actor_reference', 'requested_date': 'schedule_marker', 'decision_date': 'schedule_marker', 'approver': 'actor_reference', 'related_administrative_document': 'relation_collection', 'related_access_log_entry': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'request_number', 'requester', 'target_document'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'in_review', 'resolved', 'closed'], 'terminal_states': ['closed'], 'action_targets': {'create': None, 'assign': 'in_review', 'approve': None, 'close': 'closed'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['records become available to compliance, audit, and legal processes', 'access and disposal events become auditable'], 'related_docs': ['administrative_document', 'access_log_entry'], 'action_targets': {'create': None, 'assign': 'in_review', 'approve': None, 'close': 'closed'}, 'action_side_effects_file': 'side_effects.json'}

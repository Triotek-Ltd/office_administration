...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'requester': 'actor_reference', 'requested_date': 'schedule_marker', 'decision_date': 'schedule_marker', 'approver': 'actor_reference'}, 'search_fields': ['title', 'reference_no', 'description', 'request_no', 'requester', 'target_document'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'in_review', 'resolved', 'closed'], 'terminal_states': ['closed'], 'action_targets': {'close': 'closed', 'create': None, 'assign': 'in_review', 'approve': None}}

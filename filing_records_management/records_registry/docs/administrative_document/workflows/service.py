...
ACTION_RULES = {'archive': {'allowed_in_states': ['draft', 'active', 'disposed'], 'transitions_to': 'archived'}, 'classify': {'allowed_in_states': ['draft', 'active', 'disposed'], 'transitions_to': None}, 'review': {'allowed_in_states': ['draft', 'active', 'disposed'], 'transitions_to': None}, 'register': {'allowed_in_states': ['draft', 'active', 'disposed'], 'transitions_to': None}, 'create': {'allowed_in_states': ['draft', 'active', 'disposed'], 'transitions_to': None}, 'update': {'allowed_in_states': ['draft', 'active', 'disposed'], 'transitions_to': None}, 'file': {'allowed_in_states': ['draft', 'active', 'disposed'], 'transitions_to': None}}

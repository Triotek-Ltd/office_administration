"""Relation service seed for retention_policy."""
...
RELATED_DOCS = [{'doc_id': 'document_classification', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'disposal_action', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

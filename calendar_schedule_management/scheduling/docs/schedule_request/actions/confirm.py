"""Action handler seed for schedule_request:confirm."""
...
ACTION_ID = "confirm"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'proposed', 'confirmed', 'cancelled'], 'transitions_to': 'confirmed'}

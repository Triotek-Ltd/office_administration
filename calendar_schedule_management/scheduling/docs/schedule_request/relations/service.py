"""Relation service seed for schedule_request."""
...
RELATED_DOCS = [{'doc_id': 'calendar_event', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'requester details from linked participant or employee records'}]

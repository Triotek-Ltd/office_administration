"""Relation service seed for participant."""
...
DOC_ID = "participant"
RELATED_DOCS = [{'doc_id': 'calendar_event', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'travel_arrangement', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

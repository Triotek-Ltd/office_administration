"""Relation service seed for correspondence_followup."""
...
BORROWED_FIELDS = [{'description': 'recipient'}, {'description': 'subject'}, {'description': 'communication date from correspondence_record'}]

"""Action handler seed for correspondence_record:return_for_revision."""
...
ACTION_ID = "return_for_revision"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'in_review', 'approved', 'sent'], 'transitions_to': None}
...
def handle_return_for_revision(payload: dict, context: dict | None = None) -> dict:
    context = context or {}

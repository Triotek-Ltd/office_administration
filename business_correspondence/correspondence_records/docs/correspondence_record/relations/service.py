"""Relation service seed for correspondence_record."""
...
RELATED_DOCS = [{'doc_id': 'correspondence_type', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'correspondence_approval', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'correspondence_followup', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'administrative_document', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'party display details from linked party or contact records'}, {'description': 'filing reference from administrative_document'}]

"""Relation service seed for service_log_entry."""
...
RELATED_DOCS = [{'doc_id': 'service_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'case type'}, {'description': 'urgency'}, {'description': 'owner from service_case'}]

"""Business-domain service seed for Service Log Entry."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['service cases feed reporting, quality improvement, and risk/compliance review'], 'related_docs': ['service_case'], 'action_targets': {'record': None, 'view': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
